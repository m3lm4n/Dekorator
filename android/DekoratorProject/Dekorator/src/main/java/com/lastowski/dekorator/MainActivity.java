...
import com.lastowski.dekorator.catalog.CatalogFragment;
import com.lastowski.dekorator.catalog.CatalogItem;
import com.lastowski.dekorator.item.SpecificItemActivity;

public class MainActivity extends CommsActivity implements ActionBar.TabListener {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (scanResult != null) {
            try {
                Intent i = new Intent(MainActivity.this, SpecificItemActivity.class);
                i.putExtra(Utils.Const.BundleExtra.ITEM_ID, Integer.parseInt(scanResult.getContents()));
                startActivity(i);
            }
            catch (NumberFormatException ex){
                Log.e("MAIN_ACTIVITY", "Parsing exception");
            }
        }
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        private static final int POSITION_CATALOG = 0;
